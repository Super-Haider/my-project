...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Lab 10 Task 2 — Custom Heap Memory Driver
  ******************************************************************************
  */
...
UART_HandleTypeDef huart2;  // Changed from huart1 to huart2
...
static void MX_USART2_UART_Init(void);  // Changed to USART2
/* USER CODE BEGIN PFP */
...
void print_uart(const char* msg) {
  HAL_UART_Transmit(&huart2, (uint8_t*)msg, strlen(msg), HAL_MAX_DELAY);  // Changed to huart2
}
...
int main(void)
{
  ...
  MX_I2C1_Init();
  MX_SPI1_Init();
  MX_USART2_UART_Init();  // Changed to USART2
  //MX_USB_DEVICE_Init();
  ...
  if (block1 && block2) {
      // Store strings into the allocated memory regions
      strcpy(block1, "Hello HU, Haider here!");
      ...
      // If either allocation failed, print an error message
...
void SystemClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInit.PeriphClockSelection = RCC_PERIPHCLK_USB|RCC_PERIPHCLK_USART2
                              |RCC_PERIPHCLK_I2C1;  // Changed to USART2
  PeriphClkInit.Usart2ClockSelection = RCC_USART2CLKSOURCE_PCLK1;  // Changed to USART2
...
static void MX_USART2_UART_Init(void)
{
  ...
  huart2.Init.BaudRate = 115200;  // Changed to 115200 for faster communication
